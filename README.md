...
1. 画面右上にある設定ボタンを押す
2. 名前を入力してください
3. 通知の間隔をプルダウンから選択, または自分で入力をしてください. デフォルトでは1時間に設定されています.
4. PCの設定で使用されているブラウザの通知をオンにするとこちらの通知が表示されます
...
![タスク管理画面](docs/img/task_manage.png)

- 今日, 昨日, 今週, 先週, 今月, 先月 何時間作業をしたのかを見ることができます
